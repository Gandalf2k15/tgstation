...
/datum/component/edible/Destroy(force, silent)
	...
	QDEL_NULL(initial_reagents)
	UnregisterSignal(parent, COMSIG_PARENT_EXAMINE)
	UnregisterSignal(parent, COMSIG_ATOM_ATTACK_ANIMAL)
	UnregisterSignal(parent, COMSIG_ATOM_CHECKPARTS)
	UnregisterSignal(parent, COMSIG_ATOM_CREATEDBY_PROCESSING)
	UnregisterSignal(parent, COMSIG_ITEM_MICROWAVE_COOKED)
	UnregisterSignal(parent, COMSIG_EDIBLE_INGREDIENT_ADDED)
	UnregisterSignal(parent, COMSIG_ITEM_ATTACK)
	UnregisterSignal(parent, COMSIG_ITEM_FRIED)
	UnregisterSignal(parent, COMSIG_ITEM_MICROWAVE_ACT)
	UnregisterSignal(parent, COMSIG_ITEM_USED_AS_INGREDIENT)
	return ..()
	return ..()
